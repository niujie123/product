...
<div class="container-fluid">
    <div class="row-fluid">
        <div class="span12">
            <div style="float: right;margin-right: 20px"><?php echo CHtml::link('添加',$this->createUrl('modifyGroup'),array('class'=>'btn btn-primary'));?></div>
        </div>
        <div class="span12">
            <div class="widget-box" style="margin-right: 20px;">
                ...
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <th class="tl"><div>分组名</div></th>
                        <th class="tl"><div>描述</div></th>
                        <th class="tl"><div>左侧列表</div></th>
                        <th class="tl"><div>操作按钮</div></th>
                    ...
                    <?php }else {  foreach ($list as $k => $row){?>
                        <tr >
                            ...
                            <td><div><?php echo $row->menu;?></div></td>
                            <td><div><?php echo $row->action;?></div></td>
                            <td><div><?php echo CHtml::link('修改', $this->createUrl('modifyGroup', array('id'=>$row->id)),array('title'=>'修改', 'class'=>'btn btn-small')); ?></div></td>
                        </tr>
                    <?php }}?>
                    </tbody>
                </table>
